...
foreign lib {
	...
	@(link_name="ImGui_BeginTable")             BeginTable             :: proc(str_id: cstring, column: c.int, flags: TableFlags = {}, outer_size: Vec2 = {0.0, 0.0}, inner_width: f32 = 0.0) -> bool ---
	...
	@(link_name="ImGui_Columns")               Columns               :: proc(count: c.int = 1, id: cstring = nil, border: bool = true) ---
	...
	@(link_name="ImGui_DockSpace")             DockSpace             :: proc(id: ID, size: Vec2 = {0, 0}, flags: DockNodeFlags = {}, window_class: ^WindowClass = nil) -> ID ---
	@(link_name="ImGui_DockSpaceOverViewport") DockSpaceOverViewport :: proc(viewport: ^Viewport = nil, flags: DockNodeFlags = {}, window_class: ^WindowClass = nil) -> ID   ---
	...
	@(link_name="ImDrawList_AddEllipse")                DrawList_AddEllipse                :: proc(self: ^DrawList, center: Vec2, radius_x: f32, radius_y: f32, col: u32, rot: f32 = 0.0, num_segments: c.int = {}, thickness: f32 = 1.0)                                                         ---
	@(link_name="ImDrawList_AddEllipseFilled")          DrawList_AddEllipseFilled          :: proc(self: ^DrawList, center: Vec2, radius_x: f32, radius_y: f32, col: u32, rot: f32 = 0.0, num_segments: c.int = {})                                                                               ---
	...
	@(link_name="ImDrawList_PathEllipticalArcTo")        DrawList_PathEllipticalArcTo        :: proc(self: ^DrawList, center: Vec2, radius_x: f32, radius_y: f32, rot: f32, a_min: f32, a_max: f32, num_segments: c.int = {}) --- // Ellipse
